...
- add an example that reports an email ([#13](https://github.com/chrj/rust-spamhaus-submission/pull/13))

### Fixed

- stop the example printing the source of an email ([#14](https://github.com/chrj/rust-spamhaus-submission/pull/14))
